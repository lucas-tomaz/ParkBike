...
void handlePulse() {
  ...
  rpm = (rpmArray[0]+rpmArray[1]+rpmArray[2]+rpmArray[3])/4;
  //rpm = 45;
  ...
  Serial.print("\n");
 // Serial.print(rpmArray[0]); Serial.print(" - ");Serial.print(rpmArray[1]); Serial.print(" - ");Serial.print(rpmArray[2]); Serial.print(" - ");Serial.print(rpmArray[3]); Serial.print(" = "); Serial.println(rpm);
